              ...
              {item.docs.map((doc, dIdx) => {
                ...
                return (
                  <motion.div key={dIdx} variants={staggerItem}>
                    {isDisabled ? (
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 md:p-6 rounded-2xl border border-[#1E293B]/8 bg-[#1E293B]/[0.02] opacity-40 cursor-not-allowed">
                        <div>
                          <h4 className="text-base md:text-xl font-bold">{doc.label}</h4>
                          <p className="text-xs md:text-sm opacity-50 mt-1">{doc.desc}</p>
                        </div>
                        <span className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-gray-100 text-gray-400 text-[11px] font-bold uppercase tracking-[0.15em] shrink-0">
                      ...
                      <a
                        ...
                        className="group/doc flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 md:p-6 rounded-2xl border border-[#1E293B]/10 bg-white hover:border-[#406093]/40 hover:shadow-lg transition-all duration-300"
                      >
                        <div>
                          <h4 className="text-base md:text-xl font-bold group-hover/doc:text-[#406093] transition-colors">{doc.label}</h4>
                          <p className="text-xs md:text-sm text-[#1E293B]/50 mt-1">{doc.desc}</p>
                        </div>
                        <span className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-[#406093] text-[#F8FAFC] text-[11px] font-bold uppercase tracking-[0.15em] shadow-md group-hover/doc:bg-[#1E293B] transition-all duration-300 shrink-0">
